...
$.SmartMessageBox = function (a, b) {
  ...
  var e = 0;
  if (e = 1, a.sound === !0 && 0 == isIE8orlower()) {
  ...
  var noButtons = a.buttons ? false : true;
  ...
  if (noButtons) a.buttons = [];
  _this.hide = function(c) {
  ...
  return { obj : _this, id : SmartMSGboxCount };
};
var BigBoxes = 0;
$.bigBox = function (a, b) {
  var c;
  if (a = $.extend({
    ...
    navigator.userAgent.match('Firefox/') ? d.setAttribute('src', $.sound_path + 'bigbox.ogg')  : d.setAttribute('src', $.sound_path + 'bigbox.mp3'),
      $.get("/fake"),
...
$.smallBox = function (a, b) {
  ...
  if (a = $.extend({
    ...
    var d = document.createElement('audio');
    navigator.userAgent.match('Firefox/') ? d.setAttribute('src', $.sound_path + 'smallbox.ogg')  : d.setAttribute('src', $.sound_path + 'smallbox.mp3'),
      $.get("/fake"),
      d.addEventListener('load', function () {
        d.play()
      }, !0),
