...
exports.logError = function (e, message) {
    ...
    var stack = settings.consoleErrorPrintStack ? e.stack : "";

    if (settings.consoleThreadNumber && process.subThread) {
        console.log(colorize("Thread#" + process.threadId, -1), "Error:", e, message, stack);
    } else {
        console.log("Error: ", e, message, stack);
    }
};
